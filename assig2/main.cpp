...
int main(int argc, char** argv) {
	meshes.push_back(new Mesh("Cornell_box.obj"));
	meshes.push_back(new Mesh("Mirror.obj"));
	meshes.push_back(new Mesh("ToySit.obj"));
	meshes.push_back(new Mesh("ToyStand.obj"));
